...
namespace UnitTestProject
{
    ...
    {
        String currentGroup = "TestGroup1";
        bool isGroupsMode = true;
        ...
        public void Test_GroupDataCheck()
        {
            ...
            Assert.AreEqual(nameIsCorrect, true);
            Assert.AreEqual(minOrMaxNotZero, true);
            Assert.AreEqual(maxMoreThenMin, true);
            Assert.AreEqual(maxANotZero, true);
        }
        ...
        public void Test_ChildDataCheck()
        {
            ...
            Assert.AreEqual(true, ageMoreThemZero);
            Assert.AreEqual(true, ageInRange);
        }
    }
}
